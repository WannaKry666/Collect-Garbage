...
namespace GarbageCollection.Business.Services
{
    public class ComplaintService : IComplaintService
    {
        ...
        public async Task<ComplaintResponseDto> CreateComplaintAsync(int citizenId, int reportId, CreateComplaintDto dto)
        {
        ...
        public async Task SendMessageAsync(int citizenId, int reportId, int complaintId, SendComplaintMessageDto dto)
        {
            ...
            var newMessage = new ComplaintMessage
            {
                Sender  = "citizen",
            ...
            complaint.Messages.Add(newMessage);
            await _complaintRepository.UpdateAsync(complaint);
        }

        public async Task<ComplaintsListResult> GetComplaintsByReportAsync(int citizenId, int reportId, int page, int limit)
        {
            _ = await _reportRepository.GetByIdAsync(reportId)
                ?? throw new KeyNotFoundException("report not found");
        ...
        public async Task<ComplaintResponseDto> GetComplaintAsync(int citizenId, int reportId, int complaintId)
        {
            _ = await _reportRepository.GetByIdAsync(reportId)
                ?? throw new KeyNotFoundException("report not found");
